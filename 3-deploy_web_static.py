...
def do_pack():
    ...
    Returns:
        str: The path of the created archive, or None if the archive creation failed.
    """
    dt = datetime.utcnow()
...
def deploy():
    """
    Create a tar gzipped archive of the web_static directory and deploy it to remote servers.

    This function orchestrates the deployment process by creating an archive of the
    web_static directory, distributing it to the specified web servers, and deploying
